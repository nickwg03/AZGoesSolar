...
text_file_output = "/Users/ngrue/AZGoesSolar/data/"  # directory for text files to go into. Expects additional folders in this directory relating to the program abbreviation in the list below ("aic","aps","dvec", etc...)
...
url_info = [
            ...
            #missing ['http://arizonagoessolar.org/UtilityIncentives/GrahamCountyElectricCooperative.aspx','dnn_ctr431_XModPro_ctl00_ctl01_pgrBottom_lnkNext','gcec', ""],
            ...
            ['http://arizonagoessolar.org/UtilityIncentives/SulphurSpringsValleyElectricCooperative.aspx','dnn_ctr450_XModPro_ctl00_ctl01_pgrBottom_lnkNext','ssvec', "Sulphur Springs"],
